 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProfileDto2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProfileDto_2';
    ...
    protected static $swaggerTypes = [
        'profile_guid' => 'string',
'profile_id' => 'string',
'profile_type' => '\Hapi\Model\ProfileType2',
'hotel' => '\Hapi\Model\HotelDto2',
'name' => '\Hapi\Model\ProfileNameDto2',
'date_of_birth' => '\DateTime',
'emails' => '\Hapi\Model\ProfileEmailDto2[]',
'phones' => '\Hapi\Model\ProfilePhoneNumberDto2[]',
'loyalty_programs' => '\Hapi\Model\LoyaltyProgramDto2[]',
'addresses' => '\Hapi\Model\ProfileAddressDto2[]',
...
'occupation' => 'string',
'id_documents' => '\Hapi\Model\IdDocumentDto2[]',
'contact' => 'string',
'ar_number' => 'string',
...
'allowed_to_contact_via_email' => 'getAllowedToContactViaEmail'    ];
     ...
     * Gets profile_type
     *
     * @return \Hapi\Model\ProfileType2
     */
     ...
     * Sets profile_type
     *
     * @param \Hapi\Model\ProfileType2 $profile_type profile_type
     *
     * @return $this
     */
     ...
     * Sets hotel
     *
     * @param \Hapi\Model\HotelDto2 $hotel hotel
     *
     * @return $this
     */
     ...
     * Gets name
     *
     * @return \Hapi\Model\ProfileNameDto2
     */
     ...
     * Sets name
     *
     * @param \Hapi\Model\ProfileNameDto2 $name name
     *
     * @return $this
     */
     ...
     * Gets emails
     *
     * @return \Hapi\Model\ProfileEmailDto2[]
     */
     ...
     * Sets emails
     *
     * @param \Hapi\Model\ProfileEmailDto2[] $emails emails
     *
     * @return $this
     */
     ...
     * Gets phones
     *
     * @return \Hapi\Model\ProfilePhoneNumberDto2[]
     */
     ...
     * Sets phones
     *
     * @param \Hapi\Model\ProfilePhoneNumberDto2[] $phones phones
     *
     * @return $this
     */
     ...
     *
     * @return \Hapi\Model\LoyaltyProgramDto2[]
     */
     ...
     *
     * @param \Hapi\Model\LoyaltyProgramDto2[] $loyalty_programs loyalty_programs
     *
     * @return $this
     */
     ...
     * Gets addresses
     *
     * @return \Hapi\Model\ProfileAddressDto2[]
     */
     ...
     * Sets addresses
     *
     * @param \Hapi\Model\ProfileAddressDto2[] $addresses addresses
     *
     * @return $this
     */
     ...
     * Gets id_documents
     *
     * @return \Hapi\Model\IdDocumentDto2[]
     */
     ...
     * Sets id_documents
     *
     * @param \Hapi\Model\IdDocumentDto2[] $id_documents id_documents
     *
     * @return $this
     */
