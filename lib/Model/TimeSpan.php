 ...
 * @link     https://openapi-generator.tech
 */
class TimeSpan implements ModelInterface, ArrayAccess
{
     ...
     * Sets start
     *
     * @param string|null $start begin date of span, in YYYY-MM-DD format
     *
     * @return $this
     */
     ...
     * Sets end
     *
     * @param string|null $end end date of span, in YYYY-MM-DD format
     *
     * @return $this
     */
