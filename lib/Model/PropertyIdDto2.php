...
/**
 * PropertyIdDto2 Class Doc Comment
 *
 * @category Class
 * @description Property id in HAPI system. Presented by pair (chain code, property code)
 * @package  Hapi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PropertyIdDto2 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PropertyIdDto_2';
